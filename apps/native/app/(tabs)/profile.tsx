    ...
    <Container>
      ...
      <View className="gap-3 p-4 mb-10">
        <Animated.View
          ...
          className={`${useColorScheme() === "dark" ? "bg-[#242121]" : "bg-[#e0e0e0]"} p-10 rounded-3xl h-auto`}
        >
        ...
        <Animated.View
          entering={FadeInLeft}
          className={`${useColorScheme() === "dark" ? "bg-[#242121]" : "bg-[#e0e0e0]"} w-auto rounded-3xl  p-10 h-48`}
        >
          <View className="flex-row gap-4 mb-8">
            <Ionicons
